...
test("getRowActivitySince integration: refTable with rows returns activity entries", async () => {
  ...
  await repo.addRecordOne(refTableId, "Item", undefined, userId, "default");
