...
const currencyField = await ensureField("country", "Currency", "select", [
  "USD",
  "EUR",
  "GBP",
  "SEK",
...
for (const opt of new Set(Object.values(COUNTRY_REGIONS)))
  await ensureOption("country", regionField, opt);
for (const opt of new Set(Object.values(COUNTRY_CURRENCY)))
...
// Channel
const funnelField = await ensureField("channel", "Funnel stage", "select", [
  "Top",
  "Mid",
  "Bottom",
]);
