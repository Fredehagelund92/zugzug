...
- The subtitle "Master data reconciliation · Better Collective" reads as a client-specific tagline baked into code. It's in a generic `text-[13px]` with `--ink-2` color, carrying no visual weight.
