# DataGrid: Airtable-grade inline CRUD for master lists & value matching
...
| `chip-4` | `color-mix(--accent-2 16%, transparent)` | `#B8780F` | orange |
...
### Store mutations to add (`app/src/store.ts`)
