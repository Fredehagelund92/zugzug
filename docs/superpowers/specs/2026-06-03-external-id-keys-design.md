***REMOVED*** External-ID keys with live-resolved names
...
***REMOVED******REMOVED*** Current state (ground truth)
...
***REMOVED******REMOVED******REMOVED*** 1. Dimension gains `key_kind` + a name binding
...
***REMOVED******REMOVED******REMOVED*** 2. Read path resolves the name live
...
***REMOVED******REMOVED******REMOVED*** 3. Derive captures the binding
...
***REMOVED******REMOVED******REMOVED*** 4. UI honors "store the ID, render the name" (`MasterTables.tsx`)
...
***REMOVED******REMOVED*** Out of scope (v1) — follow-ups
