# Cosmetic Column Types — Design Spec
...
### 1.1 `NumberFormat` — two new variants
...
### 1.2 `CellType` — three new members
...
### 1.3 `ColumnConfig` — new discriminated union
...
### 1.5 Server schema — `field_config` rename
