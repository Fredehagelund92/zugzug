***REMOVED*** Sources keyboard cursor — `j/k` navigation for the warehouse ledger
...
***REMOVED******REMOVED*** Cursor lifecycle
...
***REMOVED******REMOVED*** Focused-row treatment
...
***REMOVED******REMOVED*** Input-focus guard
...
***REMOVED******REMOVED*** Implementation outline

***REMOVED******REMOVED******REMOVED*** `useSourcesCursor()` hook
...
***REMOVED******REMOVED******REMOVED*** `Sources.tsx` wiring
...
***REMOVED******REMOVED******REMOVED*** `ShortcutsOverlay` update
...
***REMOVED******REMOVED*** Files touched (estimate)
...
***REMOVED******REMOVED*** Open questions — implementer call
