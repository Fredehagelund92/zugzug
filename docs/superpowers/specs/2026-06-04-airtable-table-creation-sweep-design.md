***REMOVED*** Airtable-style table creation: one-page scaffold modal, identity, naming sweep
...
***REMOVED******REMOVED******REMOVED*** Files touched
...
***REMOVED******REMOVED******REMOVED*** Component contract — `CreateTableModal`
...
***REMOVED******REMOVED******REMOVED*** Component contract — `TablePicker` (renamed from `DimensionPicker`)
...
***REMOVED******REMOVED******REMOVED*** `POST /api/tables`
...
***REMOVED******REMOVED******REMOVED*** Validation (server-side, mirrored client-side for UX)
...
***REMOVED******REMOVED*** Data shape

***REMOVED******REMOVED******REMOVED*** `dimension` (Postgres)
...
***REMOVED******REMOVED******REMOVED*** `dimension_field.options`
...
***REMOVED******REMOVED******REMOVED*** Client types
...
***REMOVED******REMOVED******REMOVED*** Palette tokens

`app/src/lib/palette.ts` exports:

```ts
export const PALETTE: Record<PaletteName, { bg: string; fg: string; glow: string }> = {
  rose:   { bg: 'var(--tint-rose)',   fg: '***REMOVED***FF8FB1', glow: 'color-mix(in srgb,var(--tint-rose) 22%,transparent)' },
  amber:  { bg: 'var(--tint-amber)',  fg: '***REMOVED***F7C76A', glow: 'color-mix(in srgb,var(--tint-amber) 22%,transparent)' },
  // ... etc
};
```
...
***REMOVED******REMOVED*** Modal UX detail

***REMOVED******REMOVED******REMOVED*** Layout (single column, 520 px wide)
...
***REMOVED******REMOVED******REMOVED*** Identity
...
***REMOVED******REMOVED******REMOVED*** Mode segment
...
***REMOVED******REMOVED******REMOVED*** Swappable region
...
***REMOVED******REMOVED******REMOVED*** Submit behavior
...
***REMOVED******REMOVED******REMOVED*** Keyboard
...
***REMOVED******REMOVED*** Naming sweep & capitalization rule

***REMOVED******REMOVED******REMOVED*** Vocabulary swap (user-facing only)
...
***REMOVED******REMOVED******REMOVED*** Capitalization rule (codified)
...
***REMOVED******REMOVED******REMOVED*** Server
...
***REMOVED******REMOVED******REMOVED*** Smoke / regression
...
***REMOVED******REMOVED*** Out of scope but worth flagging for future specs
