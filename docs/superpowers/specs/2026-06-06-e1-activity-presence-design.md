***REMOVED*** E1 — Activity & Presence — Design Spec
...
***REMOVED******REMOVED******REMOVED*** Three-store impact
...
***REMOVED******REMOVED*** Prerequisite migration (blocking)
...
***REMOVED******REMOVED******REMOVED*** `server/src/realtime/presence-room.ts`
...
***REMOVED******REMOVED******REMOVED*** WebSocket route — added inline to `server/src/server.ts`
...
***REMOVED******REMOVED******REMOVED*** `server/src/repo-activity.ts`
...
***REMOVED******REMOVED******REMOVED*** Activity route — added inline to `server/src/server.ts`
...
***REMOVED******REMOVED******REMOVED*** Commit-time hint emission
...
***REMOVED******REMOVED******REMOVED*** `app/src/lib/use-presence.ts`
...
***REMOVED******REMOVED******REMOVED*** `app/src/components/datagrid/CursorOverlay.tsx`
...
***REMOVED******REMOVED******REMOVED*** `app/src/components/datagrid/RowActivityBadge.tsx`
...
***REMOVED******REMOVED******REMOVED*** `app/src/lib/use-row-activity.ts`
...
***REMOVED******REMOVED******REMOVED*** `app/src/lib/use-presence-color.ts`
...
***REMOVED******REMOVED******REMOVED*** `app/src/components/datagrid/PresenceStrip.tsx`
...
***REMOVED******REMOVED*** Explicitly out of scope
