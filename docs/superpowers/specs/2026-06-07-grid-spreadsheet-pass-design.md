***REMOVED*** Grid Spreadsheet Pass — Design Spec
...
4. **Click row***REMOVED*** / column-header to select whole row/column** — turn the gutter into a selection surface.
...
- **Presence cursors** — already covered by Epic E1 (***REMOVED***54 and ***REMOVED***46–53). Not in this spec.
- **Per-cell revision history** — depends on E1's audit-log foundation (***REMOVED***46) and row-activity API (***REMOVED***47). The right-click menu reserves a slot for it but the UI surface is excluded from v1.
...
| Row***REMOVED***/header click select  | folded into existing `onCellPointerDown` + header pointer-down  |
...
***REMOVED******REMOVED*** 1. Fill Handle

***REMOVED******REMOVED******REMOVED*** 1.1 Purpose
...
***REMOVED******REMOVED******REMOVED*** 1.2 Gesture
...
***REMOVED******REMOVED******REMOVED*** 1.3 Source semantics
...
***REMOVED******REMOVED******REMOVED*** 1.4 Why vertical-only
...
***REMOVED******REMOVED******REMOVED*** 1.5 Commit and undo
...
***REMOVED******REMOVED******REMOVED*** 1.6 Edge cases
...
***REMOVED******REMOVED******REMOVED*** 1.7 Tests
...
***REMOVED******REMOVED*** 2. ⌘+Arrow Data-Edge Jump

***REMOVED******REMOVED******REMOVED*** 2.1 Purpose
...
***REMOVED******REMOVED******REMOVED*** 2.2 Semantics
...
***REMOVED******REMOVED******REMOVED*** 2.3 Bindings
| Keystroke      | Action                                       |
|----------------|----------------------------------------------|
...
***REMOVED******REMOVED******REMOVED*** 2.4 Implementation
...
***REMOVED******REMOVED******REMOVED*** 2.5 Conflicts
...
***REMOVED******REMOVED******REMOVED*** 2.6 Tests
...
***REMOVED******REMOVED*** 3. Status-Bar Live Aggregates

***REMOVED******REMOVED******REMOVED*** 3.1 Purpose
...
***REMOVED******REMOVED******REMOVED*** 3.2 UI
...
***REMOVED******REMOVED******REMOVED*** 3.3 Computed values
...
***REMOVED******REMOVED******REMOVED*** 3.4 Implementation
...
***REMOVED******REMOVED******REMOVED*** 3.5 Tests
...
***REMOVED******REMOVED*** 4. Click Row***REMOVED*** / Column-Header to Select

***REMOVED******REMOVED******REMOVED*** 4.1 Purpose
...
***REMOVED******REMOVED******REMOVED*** 4.2 Semantics
| Click target                          | Result                                                            |
|--------------------------------------|--------------------------------------------------------------------|
...
***REMOVED******REMOVED******REMOVED*** 4.3 Implementation
...
***REMOVED******REMOVED******REMOVED*** 4.4 Edge cases
...
***REMOVED******REMOVED******REMOVED*** 4.5 Tests
...
***REMOVED******REMOVED*** 5. Right-Click Context Menu

***REMOVED******REMOVED******REMOVED*** 5.1 Purpose
...
***REMOVED******REMOVED******REMOVED*** 5.2 Surfaces and items
...
***REMOVED******REMOVED******REMOVED*** 5.3 Component
...
***REMOVED******REMOVED******REMOVED*** 5.4 Native menu suppression
...
***REMOVED******REMOVED******REMOVED*** 5.5 Tests
...
***REMOVED******REMOVED*** 6. Conditional Formatting

***REMOVED******REMOVED******REMOVED*** 6.1 Purpose
...
***REMOVED******REMOVED******REMOVED*** 6.2 Rule model
...
***REMOVED******REMOVED******REMOVED*** 6.3 Evaluation
...
***REMOVED******REMOVED******REMOVED*** 6.4 Editor
...
***REMOVED******REMOVED******REMOVED*** 6.5 Performance
...
***REMOVED******REMOVED******REMOVED*** 6.6 Tests
...
***REMOVED******REMOVED*** 7. Field Description Tooltips

***REMOVED******REMOVED******REMOVED*** 7.1 Purpose
"What does `acct_src_code` mean?" needs a one-hover answer that lives with the column, not in a separate docs page.

***REMOVED******REMOVED******REMOVED*** 7.2 Schema migration
...
***REMOVED******REMOVED******REMOVED*** 7.3 ColumnDef extension
...
***REMOVED******REMOVED******REMOVED*** 7.4 Header render
...
***REMOVED******REMOVED******REMOVED*** 7.5 Editor
...
***REMOVED******REMOVED******REMOVED*** 7.6 Tests
...
***REMOVED******REMOVED*** 8. Out of Scope

Explicitly **not in this spec** (each defers to a different epic or future pass):

- **Presence cursors / selection halos** — Epic E1 (***REMOVED***54).
- **Per-cell revision history popover** — depends on E1 audit foundation (***REMOVED***46–48); right-click leaves a slot.
...
***REMOVED******REMOVED*** 9. Testing strategy
