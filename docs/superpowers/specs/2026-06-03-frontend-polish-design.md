***REMOVED*** Frontend polish for review-readiness
...
***REMOVED******REMOVED******REMOVED*** Theme 1 — Strip jargon (engineer-mode toggle)
...
***REMOVED******REMOVED******REMOVED*** Theme 5 — Automation surface
...
***REMOVED******REMOVED******REMOVED*** Theme 6 — Polish & bug fixes
...
`main.tsx:34` writes raw HTML into `***REMOVED***root` on API failure. Replace with a small
...
***REMOVED******REMOVED*** What's not in scope
