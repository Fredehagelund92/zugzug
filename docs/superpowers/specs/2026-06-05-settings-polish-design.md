***REMOVED*** Settings revamp + UI polish — design spec
...
***REMOVED******REMOVED*** Part 1: Scan scheduling
...
***REMOVED******REMOVED******REMOVED*** Why this is the right call
...
***REMOVED******REMOVED******REMOVED*** Server changes
...
***REMOVED******REMOVED******REMOVED*** Client changes
...
***REMOVED******REMOVED*** Part 2: Settings page revamp
...
***REMOVED******REMOVED******REMOVED*** Scans section
...
***REMOVED******REMOVED******REMOVED*** `SegControl` component
...
***REMOVED******REMOVED******REMOVED*** `ScanStatusStrip` sub-component
...
***REMOVED******REMOVED*** Part 3: Z-index normalization
...
***REMOVED******REMOVED******REMOVED*** Priority fixes
...
***REMOVED******REMOVED*** Part 4: Focus ring sweep

***REMOVED******REMOVED******REMOVED*** Standard
...
***REMOVED******REMOVED******REMOVED*** Missing rings — exhaustive list
...
***REMOVED******REMOVED******REMOVED*** Consistency with existing rings
...
***REMOVED******REMOVED*** Part 5: `transition-colors` consistency
...
***REMOVED******REMOVED*** Part 6: `schedule` column cleanup
...
***REMOVED******REMOVED*** What is NOT in scope
