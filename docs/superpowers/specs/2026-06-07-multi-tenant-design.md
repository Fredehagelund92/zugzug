***REMOVED*** Multi-tenant (workspaces) — design
...
**Supersedes:** scope of GitHub epic ***REMOVED***36 — child issues ***REMOVED***28/***REMOVED***29/***REMOVED***31/***REMOVED***32 are absorbed into phase 2; ***REMOVED***30 (parse Google `hd`) stays standalone.

***REMOVED******REMOVED*** Goal

Add multi-tenancy to Zugzug so Zugzug's internal sub-teams (Sportsbook, iGaming, Affiliates, etc.) each get an isolated workspace within the same deployment. Existing data becomes a single `default` tenant.
...
***REMOVED******REMOVED*** Decisions locked during brainstorming
...
8. **Phase 1 ships with a single hardcoded `'admin'` role** on every `tenant_member`. Phase 2 (separate spec, absorbing ***REMOVED***36) adds admin/editor/viewer with gating and the Team settings UI.
...
***REMOVED******REMOVED******REMOVED*** Tables that gain `tenant_id`
...
***REMOVED******REMOVED******REMOVED*** Tables that stay global (no `tenant_id`)
...
***REMOVED******REMOVED******REMOVED*** Dropped
...
***REMOVED******REMOVED******REMOVED*** Dynamic `dim_*` / `map_*` tables
...
***REMOVED******REMOVED******REMOVED*** Super-admin
...
***REMOVED******REMOVED*** Auth & request lifecycle
...
***REMOVED******REMOVED******REMOVED*** TenantRepo
...
***REMOVED******REMOVED******REMOVED*** Sign-in flow
...
***REMOVED******REMOVED******REMOVED*** Super-admin routes
...
***REMOVED******REMOVED******REMOVED*** `apiFetch` (module-level function, not a hook)
...
***REMOVED******REMOVED******REMOVED*** ESLint rule (no plugin needed)
...
***REMOVED******REMOVED******REMOVED*** Workspace switcher
...
***REMOVED******REMOVED******REMOVED*** Switch-generation counter (race fix)
...
***REMOVED******REMOVED******REMOVED*** Cancel-on-switch (debounce fix)
...
***REMOVED******REMOVED******REMOVED*** Hardcoded nav hrefs
...
***REMOVED******REMOVED******REMOVED*** Tenant-scoped `localStorage`
...
***REMOVED******REMOVED******REMOVED*** Redirect in BootGate
...
***REMOVED******REMOVED******REMOVED*** Deploy 1 — additive only
...
***REMOVED******REMOVED******REMOVED*** Deploy 2 — cutover (single coordinated change)
...
***REMOVED******REMOVED******REMOVED*** Phase 1.5 — RLS (separate deploy after phase 1 settles)
...
***REMOVED******REMOVED*** Phase 1 deliverables (epic checklist)
...
***REMOVED******REMOVED*** Phase 2 (separate spec; supersedes ***REMOVED***36)
...
- ***REMOVED***30: parse Google `hd` JWT claim for signed-domain trust

***REMOVED******REMOVED*** Phase 3 (no spec yet)
