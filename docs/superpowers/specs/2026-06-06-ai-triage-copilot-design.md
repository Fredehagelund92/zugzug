***REMOVED*** AI Triage Co-pilot — Design Spec
...
***REMOVED******REMOVED*** Server: `repo-ai-hint.ts`

New file at `server/src/repo-ai-hint.ts`.

***REMOVED******REMOVED******REMOVED*** `getAiHint(dimId, raw, canonicalLabels, dimContext)`
...
***REMOVED******REMOVED******REMOVED*** `callClaude(raw, canonicalLabels, dimContext)`
...
***REMOVED******REMOVED******REMOVED*** `validateClaudeResponse(raw, canonicalLabels)`
...
***REMOVED******REMOVED*** Server: `GET /api/triage/ai-hint`
...
***REMOVED******REMOVED*** Client: `useAiHint` hook
...
***REMOVED******REMOVED*** UI: `TriageReasoningStrip`

New component at `app/src/components/TriageReasoningStrip.tsx`.

***REMOVED******REMOVED******REMOVED*** Placement
...
***REMOVED******REMOVED******REMOVED*** Loading state
...
***REMOVED******REMOVED******REMOVED*** Loaded state
...
***REMOVED******REMOVED******REMOVED*** Error state

Renders nothing — confidence bar alone is sufficient fallback.

***REMOVED******REMOVED******REMOVED*** Confidence column
...
***REMOVED******REMOVED*** Integration: Parallel Data Path
...
***REMOVED******REMOVED*** Trust Calibration
