***REMOVED*** Number Format Options Implementation Plan
...
***REMOVED******REMOVED*** Task 1: `NumberFormat` type — client side
...
***REMOVED******REMOVED*** Task 2: `formatNumber` helper + `NumberCell` update
...
***REMOVED******REMOVED*** Task 3: `ColumnHeaderMenu` number-format sub-panel
...
***REMOVED******REMOVED*** Task 4: `AddFieldPopover` format panel
...
***REMOVED******REMOVED*** Task 5: `TablePane` field→column mapping
...
***REMOVED******REMOVED*** Task 6: Server — `NumberFormat` type + `FieldDef` + `listFields` parse branch
...
***REMOVED******REMOVED*** Task 7: Server — `addField` + `changeColumnType` persist `numberFormat`
...
***REMOVED******REMOVED*** Task 8: Server endpoints + `tables.ts`
