***REMOVED*** AI Triage Co-pilot Implementation Plan
...
***REMOVED******REMOVED*** Task 2: Add `anthropicApiKey` to env
...
```
***REMOVED*** Optional: enables AI Triage suggestions (get a key at https://console.anthropic.com)
ANTHROPIC_API_KEY=
```
...
***REMOVED******REMOVED*** Task 3: `repo-ai-hint.ts` — `validateClaudeResponse` + `callClaude`
...
***REMOVED******REMOVED*** Task 4: `repo-ai-hint.ts` — `getAiHint` (cache layer)
...
***REMOVED******REMOVED*** Task 5: Re-export + server route
...
***REMOVED******REMOVED*** Task 6: Prune stale hints after `commit()`
...
***REMOVED******REMOVED*** Task 7: Update hint label on `renameCanonical`
...
***REMOVED******REMOVED*** Task 8: `useAiHint` hook + tests
...
***REMOVED******REMOVED*** Task 9: `TriageReasoningStrip` component
...
***REMOVED******REMOVED*** Task 10: Wire everything into `Triage.tsx`
...
***REMOVED******REMOVED*** Task 11: Smoke walkthrough
...
***REMOVED******REMOVED*** Note: Settings toggle (follow-up)
