***REMOVED*** Phase 2 — Implement `SnowflakeAdapter` (no live instance)
...
```
server/
  package.json                              ***REMOVED*** snowflake-sdk + @types/snowflake-sdk added
server/src/warehouse/snowflake/
  index.ts                                  ***REMOVED*** SnowflakeAdapter — bulk of the implementation
  sdk-wrapper.ts                            ***REMOVED*** NEW — SnowflakeConnection promise wrapper + factory
server/test/
  warehouse-snowflake.test.ts               ***REMOVED*** NEW — unit tests with mocked connection
  warehouse-snowflake-sql.fixture.md        ***REMOVED*** NEW — documented expected SQL strings for live validation
```

---

***REMOVED******REMOVED*** Task 1: Add `snowflake-sdk` and `@types/snowflake-sdk` deps
...
***REMOVED******REMOVED*** Task 2: Build `SnowflakeConnection` promise wrapper
...
***REMOVED******REMOVED*** Task 3: Replace `SnowflakeAdapter` stub with constructor-injectable shell
...
***REMOVED******REMOVED******REMOVED*** Step 1 — Write the failing tests
...
***REMOVED******REMOVED******REMOVED*** Step 2 — Verify tests fail
...
***REMOVED******REMOVED******REMOVED*** Step 3 — Rewrite the stub
 ...
 *
 * Identifier case-folding (the ***REMOVED***1 footgun): Snowflake stores UNQUOTED
...
***REMOVED******REMOVED******REMOVED*** Step 4 — Run tests, verify they pass
...
***REMOVED******REMOVED******REMOVED*** Step 5 — Typecheck
...
***REMOVED******REMOVED*** Task 4: Implement `ping()`

**Files:**
- Modify: `server/src/warehouse/snowflake/index.ts`
- Modify: `server/test/warehouse-snowflake.test.ts`

***REMOVED******REMOVED******REMOVED*** Step 1 — Add failing test
...
***REMOVED******REMOVED******REMOVED*** Step 3 — Implement `ping()`
...
***REMOVED******REMOVED*** Task 5: Implement catalog methods (`tableExists`, `listTables`, `listColumns`)
...
***REMOVED******REMOVED******REMOVED*** Step 1 — Add failing tests
...
***REMOVED******REMOVED******REMOVED*** Step 3 — Implement the three catalog methods
...
***REMOVED******REMOVED*** Task 6: Implement value-scan methods (`distinctValues`, `topValuesByFrequency`, `columnStats`, `nameResolution`)
...
***REMOVED******REMOVED******REMOVED*** Step 3 — Implement the four methods
...
***REMOVED******REMOVED*** Task 7: Implement `distinctValuesWithProvenance`
...
***REMOVED******REMOVED******REMOVED*** Step 3 — Implement the method
...
***REMOVED******REMOVED*** Task 8: Implement `ensureCanonicalTables`
...
***REMOVED******REMOVED*** Task 9: Implement `commitCanonical` (the writable MERGE path)
...
***REMOVED******REMOVED******REMOVED*** Step 3 — Implement `commitCanonical`
...
***REMOVED******REMOVED*** Task 10: Wire factory in `server.ts` + `bootstrap.ts` (verify, no change needed)
...
***REMOVED******REMOVED*** Task 11: Write live-validation SQL fixture doc
...
```markdown
***REMOVED*** SnowflakeAdapter — expected SQL strings (live-validation reference)
...
***REMOVED******REMOVED*** tableExists({schema: 'RAW', table: 'PARTNERS'})
...
***REMOVED******REMOVED*** listColumns({schema: 'RAW', table: 'PARTNERS'})
...
***REMOVED******REMOVED*** distinctValues({schema: 'RAW', table: 'PARTNERS'}, 'REGION', 100)
...
***REMOVED******REMOVED*** topValuesByFrequency({schema: 'RAW', table: 'PARTNERS'}, 'REGION', 10)
...
***REMOVED******REMOVED*** columnStats({schema: 'RAW', table: 'PARTNERS'}, 'REGION', {approximate: false})
...
***REMOVED******REMOVED*** columnStats({schema: 'RAW', table: 'PARTNERS'}, 'REGION', {approximate: true})
...
***REMOVED******REMOVED*** nameResolution({schema: 'RAW', table: 'COUNTRIES'}, 'CODE', 'LABEL')
...
***REMOVED******REMOVED*** distinctValuesWithProvenance — 2 sources
...
***REMOVED******REMOVED*** ensureCanonicalTables
...
***REMOVED******REMOVED*** commitCanonical — small batch (3 drafts)
...
***REMOVED******REMOVED*** Live-validation checklist
...
***REMOVED******REMOVED*** Task 12: Final verification gates
