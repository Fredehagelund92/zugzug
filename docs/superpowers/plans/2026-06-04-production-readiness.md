***REMOVED*** Production-Readiness Implementation Plan
...
***REMOVED******REMOVED*** Phase 1 — Stop-the-bleeding (1–2 days)
...
***REMOVED******REMOVED******REMOVED*** Task 1.1: Wrap `mergeCanonical` in a transaction
...
***REMOVED******REMOVED******REMOVED*** Task 1.2: Graceful shutdown on SIGTERM/SIGINT
...
***REMOVED******REMOVED******REMOVED*** Task 1.3: `/health` endpoint with Postgres ping
...
***REMOVED******REMOVED******REMOVED*** Task 1.4: Replace CORS `*` with `env.origin`
...
***REMOVED******REMOVED******REMOVED*** Task 1.5: Drop `devBypass` from public `/api/auth/config`
...
***REMOVED******REMOVED******REMOVED*** Task 1.6: Delete the MotherDuck token SQL interpolation
...
***REMOVED******REMOVED******REMOVED*** Task 1.7: `Bun.serve` request body size limit
...
***REMOVED******REMOVED******REMOVED*** Task 1.8: Explicit Postgres pool sizing
...
```bash
***REMOVED*** Postgres pool sizing — defaults to 5 for the main pool.
***REMOVED*** Migrations run with their own max=1 connection.
PG_POOL_MAX=5
```
...
***REMOVED******REMOVED******REMOVED*** Task 1.9: Route-level React error boundary
...
***REMOVED******REMOVED******REMOVED*** Task 1.10: Hide `window.BrandApp` in production builds
...
***REMOVED******REMOVED*** Phase 2 — Audit truth + N+1s + stale closures (2–3 days)
...
***REMOVED******REMOVED******REMOVED*** Task 2.1: Thread `userId` through every audit call
...
***REMOVED******REMOVED******REMOVED*** Task 2.2: Authorization gate on `mergeCanonical`
...
***REMOVED******REMOVED******REMOVED*** Task 2.3: Batch user lookups in `listAudit`
...
***REMOVED******REMOVED******REMOVED*** Task 2.4: Batch user lookups in `listDrafts`
...
***REMOVED******REMOVED******REMOVED*** Task 2.5: Parallelize per-dimension counts in `listDimensions`
...
***REMOVED******REMOVED******REMOVED*** Task 2.6: Fix the three stale-closure `useEffect`s
...
***REMOVED******REMOVED*** Phase 3 — Accessibility pass (1 day)
...
***REMOVED******REMOVED******REMOVED*** Task 3.1: `CreateTableModal` ARIA + focus trap
...
***REMOVED******REMOVED******REMOVED*** Task 3.2: `AddFieldPopover` focus trap
...
***REMOVED******REMOVED******REMOVED*** Task 3.3: `ComboSelect` Tab-closes-listbox
...
***REMOVED******REMOVED******REMOVED*** Task 3.4: `ScanScheduleMenu` keyboard nav
...
***REMOVED******REMOVED******REMOVED*** Task 3.5: `DataGrid` ARIA grid roles
...
***REMOVED******REMOVED******REMOVED*** Task 4.2: Per-source scan timing + slow-query log
...
***REMOVED******REMOVED******REMOVED*** Task 4.3: Sentry on the frontend
...
***REMOVED******REMOVED*** Phase 5 — DX baseline (1 day)

**Goal of phase:** PRs get automated feedback before review.

***REMOVED******REMOVED******REMOVED*** Task 5.1: ESLint in `app/`
...
***REMOVED******REMOVED******REMOVED*** Task 5.2: ESLint in `server/`
...
***REMOVED******REMOVED******REMOVED*** Task 5.3: Prettier in both packages
...
***REMOVED******REMOVED******REMOVED*** Task 5.4: Typed `getValue` accessor in DataGrid
...
***REMOVED******REMOVED*** Phase 6 — Deploy (1 day)
...
***REMOVED******REMOVED******REMOVED*** Task 6.1: Server Dockerfile
...
***REMOVED******REMOVED******REMOVED*** Task 6.2: App Dockerfile (static)
...
server {
  ...
  ***REMOVED*** Long-cache the hashed asset bundles; never cache index.html.
...
***REMOVED******REMOVED******REMOVED*** Task 6.3: GitHub Actions CI (typecheck + lint)
...
***REMOVED******REMOVED*** Phase 7 — Tests (3–5 days)
...
***REMOVED******REMOVED******REMOVED*** Task 7.1: Backend test harness with disposable Postgres
...
```yaml
***REMOVED*** server/docker-compose.test.yml
services:
  pg:
...
***REMOVED******REMOVED******REMOVED*** Task 7.2: `commit()` happy-path test
...
***REMOVED******REMOVED******REMOVED*** Task 7.3: `mergeCanonical` atomicity test
...
***REMOVED******REMOVED******REMOVED*** Task 7.4: `addDimension` idempotency test
...
***REMOVED******REMOVED******REMOVED*** Task 7.5: Frontend Vitest setup
...
***REMOVED******REMOVED******REMOVED*** Task 7.6: Store pure-helper tests
...
***REMOVED******REMOVED******REMOVED*** Task 7.7: DataGrid keyboard nav test
...
***REMOVED******REMOVED******REMOVED*** Task 7.8: Wire tests into CI
...
***REMOVED******REMOVED*** Phase 8 — Tech debt cleanup (optional, ongoing)

**Goal of phase:** Structural debt that's safe to defer but worth scheduling. Pick one per sprint.

***REMOVED******REMOVED******REMOVED*** Task 8.1: Split `repo.ts` into domain files
...
***REMOVED******REMOVED******REMOVED*** Task 8.2: `AppError` base + error-code enum
...
***REMOVED******REMOVED******REMOVED*** Task 8.3: DuckDB call serialization queue
...
***REMOVED******REMOVED******REMOVED*** Task 8.4: Narrow `refreshDim` + memoized `GridRow`
...
***REMOVED******REMOVED*** Execution handoff
