***REMOVED*** Frontend polish for review-readiness — Implementation Plan
...
***REMOVED******REMOVED*** Task 1: `useEngineerMode` hook + provider
...
***REMOVED******REMOVED*** Task 2: `EngineerModeToggle` component
...
***REMOVED******REMOVED*** Task 3: Wrap the app in `EngineerModeProvider` + add toggle to topbar
...
***REMOVED******REMOVED*** Task 4: Apply engineer mode to AppShell (sidebar footer + nav labels + remove search)
...
***REMOVED******REMOVED*** Task 5: Apply engineer mode to DimensionPicker
...
***REMOVED******REMOVED*** Task 6: Apply engineer mode + crash fix + bulk-merge hint to MasterTables
...
***REMOVED******REMOVED*** Task 7: Apply engineer mode + crash fix + microcopy to Mapping route
...
***REMOVED******REMOVED*** Task 8: Apply engineer mode + microcopy to Sources route
...
***REMOVED******REMOVED*** Task 9: Settings — Connections rework + remove duplicate theme picker + add engineer toggle row
...
***REMOVED******REMOVED*** Task 10: BootGate — loading skeleton + styled error fallback
...
***REMOVED******REMOVED*** Task 11: Accessibility audit pass
...
***REMOVED******REMOVED*** Task 12: Backend — `app.preferences` table + endpoints
...
***REMOVED*** expect: {"publishThreshold":95,"suggestThreshold":80}
...
curl -s http://localhost:8787/api/preferences | jq
***REMOVED*** expect: {"publishThreshold":90,"suggestThreshold":75}
***REMOVED*** reset:
...
***REMOVED******REMOVED*** Task 13: Client — `usePreferences` hook + preload + setter
...
***REMOVED******REMOVED*** Task 14: `ThresholdRange` two-thumb slider component
...
***REMOVED******REMOVED*** Task 15: Settings — replace single slider with `ThresholdRange`
...
***REMOVED******REMOVED*** Task 16: Server — auto-stage drafts on scan when confidence ≥ publish threshold
...
***REMOVED******REMOVED*** Task 17: Backend — per-source schedule column + endpoints
...
***REMOVED*** expect a `schedule` field on the row
```
...
***REMOVED******REMOVED*** Task 18: Server — `setInterval` scheduler loop
...
***REMOVED******REMOVED*** Task 19: Client — `ScanScheduleMenu` component + Sources integration
...
***REMOVED******REMOVED*** Self-review against the spec
