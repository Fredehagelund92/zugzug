# Settings Revamp + UI Polish Implementation Plan
...
## Task 2: Server — Preferences type + repo-meta CRUD
...
## Task 3: Server — anyScanDue + scanStatus + setSourceSchedule removal
...
## Task 6: Delete ScanScheduleMenu + clean LedgerRow
...
## Task 10: Focus ring + transition-colors sweep
