***REMOVED*** External-ID Keys with Live-Resolved Names — Implementation Plan
...
***REMOVED******REMOVED*** Key assumption (confirm at plan review)
...
***REMOVED******REMOVED*** Task 0: (Optional) initialize git for commit checkpoints
...
***REMOVED******REMOVED*** Task 1: Schema migration — `key_kind` + name binding
...
***REMOVED******REMOVED*** Task 2: `addDimension` — create external-ID dimensions
...
***REMOVED******REMOVED*** Task 3: `deriveCanonical` — two-column external-ID path + binding
...
***REMOVED******REMOVED*** Task 4: `getDimension` live resolution + `unresolved`; `listDimensions` projection
...
***REMOVED******REMOVED*** Task 5: `scanValues` — live-resolve `current` for the reconcile screen
...
***REMOVED******REMOVED*** Task 6: API routes — `keyKind` on create, `nameColumn` on derive
...
***REMOVED******REMOVED*** Task 7: `verify-eid.ts` — regression harness
...
***REMOVED******REMOVED*** Task 8: Client types + store signatures
...
***REMOVED******REMOVED*** Task 9: MasterTables — unresolved badge, no rename, no slug-add, two-column derive
...
***REMOVED******REMOVED*** Task 10: DimensionPicker external-ID toggle + Mapping `allowCreate`
...
```bash
cd server && bun run start   ***REMOVED*** :8787, in one terminal
cd app && bun run dev        ***REMOVED*** :5173, in another
```
...
***REMOVED******REMOVED*** Self-review (completed)
