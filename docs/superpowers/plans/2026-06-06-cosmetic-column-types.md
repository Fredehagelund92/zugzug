***REMOVED*** Cosmetic Column Types Implementation Plan
...
***REMOVED******REMOVED*** Task 1: Rename dimension_field.options → field_config
...
***REMOVED******REMOVED*** Task 2: Extend NumberFormat + parseFieldConfig + FieldDef (repo-shared.ts)
...
***REMOVED******REMOVED*** Task 3: Refactor changeColumnType to options-object + add new coercion rules
...
***REMOVED******REMOVED*** Task 4: Update addField and listFields for new types
...
***REMOVED******REMOVED*** Task 5: Update client store.ts to pass ratingMax
...
***REMOVED******REMOVED*** Task 6: ColumnConfig discriminated union (client types)
...
***REMOVED******REMOVED*** Task 7: Migrate DataGrid.tsx to col.config
...
***REMOVED******REMOVED*** Task 8: Migrate NumberCell.tsx + add compact/duration formats
...
***REMOVED******REMOVED*** Task 9: Migrate ColumnHeaderMenu.tsx
...
***REMOVED******REMOVED*** Task 10: Migrate TablePane.tsx (fieldDefToColumnConfig helper)
...
***REMOVED******REMOVED*** Task 11: UrlCell and EmailCell
...
***REMOVED******REMOVED*** Task 12: RatingCell
...
***REMOVED******REMOVED*** Task 13: Register UrlCell, EmailCell, RatingCell in DataGrid
...
***REMOVED******REMOVED*** Task 14: AddFieldPopover — new tiles + ratingMax + compact/duration config
...
***REMOVED******REMOVED*** Task 15: Server integration verification
