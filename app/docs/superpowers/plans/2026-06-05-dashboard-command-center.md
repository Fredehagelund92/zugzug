***REMOVED*** Dashboard Command Center Implementation Plan
...
***REMOVED******REMOVED*** Task 1: dashboard-helpers.ts + tests
...
***REMOVED******REMOVED*** Task 2: Extend Kpi with `"warn"` dir + update KPI sub-lines
...
***REMOVED******REMOVED*** Task 3: Add toolbar to Dashboard
...
***REMOVED******REMOVED*** Task 4: DimHealthTable
...
***REMOVED******REMOVED*** Task 5: Remove old layout sections + final cleanup
...
***REMOVED******REMOVED*** Task 6: Visual smoke test
