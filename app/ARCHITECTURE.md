...
***REMOVED******REMOVED*** Cost (MotherDuck billing)
...
***REMOVED******REMOVED*** What's mocked vs real
...
***REMOVED******REMOVED*** Multi-user (in the UI today)
...
***REMOVED******REMOVED*** Implemented backend (`../server/`) — now real
