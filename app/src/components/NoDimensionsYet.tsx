...
/* NoDimensionsYet — shared empty-state for the value-mapping + master-list
   routes when the workspace has zero master lists. Replaces a crash that
  ...
  return (
    <div className="zz-rise mx-auto max-w-xl rounded-lg border border-line bg-surface p-10 text-center">
      ...
      <p className="mt-3 text-ink-2">
        Create a master list from scratch, or import one from a warehouse column.
      </p>
