...
***REMOVED******REMOVED*** Now (in active development)

The one initiative actively being worked on. One thing at a time.

***REMOVED******REMOVED******REMOVED*** v0.1 launch readiness
...
***REMOVED******REMOVED*** Next (queued for v0.2)
...
***REMOVED******REMOVED******REMOVED*** Curation features

| Item | Status | Trigger |
|---|---|---|
| [***REMOVED***45 — Error recovery: canonical_history + per-record revert](https://github.com/Fredehagelund92/zugzug/issues/45) | Planned | After first incident where committed mutations need rolling back, or sufficient inbound demand. |
| [***REMOVED***33 — Bulk operations in Triage + cascade delete](https://github.com/Fredehagelund92/zugzug/issues/33) | Wanted | After v1.0, or first community feature request. |
| [***REMOVED***34 — CSV import/export](https://github.com/Fredehagelund92/zugzug/issues/34) | Wanted | Parquet export covers v0.1; CSV is a v1.x convenience. |
| [***REMOVED***35 — Unified search (Cmd-K)](https://github.com/Fredehagelund92/zugzug/issues/35) | Wanted | After v1.0. |
| [***REMOVED***3](https://github.com/Fredehagelund92/zugzug/issues/3), [***REMOVED***4](https://github.com/Fredehagelund92/zugzug/issues/4), [***REMOVED***5](https://github.com/Fredehagelund92/zugzug/issues/5) — AI-assisted suggestions | Exploring | Need design first; not adoption-blocking. |
| [***REMOVED***15 — Scan scheduler hardening](https://github.com/Fredehagelund92/zugzug/issues/15) | Wanted | First production scan failure that loses data. |

***REMOVED******REMOVED******REMOVED*** Collaboration

| Item | Status | Trigger |
|---|---|---|
| [***REMOVED***54 — Activity feed + presence](https://github.com/Fredehagelund92/zugzug/issues/54) | Wanted | After v1.0; realtime infrastructure is its own scope. |
| [***REMOVED***55 — Concurrent editing safety (LWW prevention)](https://github.com/Fredehagelund92/zugzug/issues/55) | Wanted | After ***REMOVED***54 ships, or first last-write-wins incident. |

***REMOVED******REMOVED******REMOVED*** Auth + access control

| Item | Status | Trigger |
|---|---|---|
| [***REMOVED***36 — RBAC phase 2 (non-admin roles)](https://github.com/Fredehagelund92/zugzug/issues/36) | Wanted | First team that wants per-dimension permissions. |
...
***REMOVED******REMOVED******REMOVED*** Multi-tenancy / hosted offering

| Item | Status | Trigger |
|---|---|---|
| [***REMOVED***59 — Multi-tenant workspaces (UI)](https://github.com/Fredehagelund92/zugzug/issues/59) | Gated | Schema + middleware exist behind `ZUGZUG_MULTI_TENANT`; surfacing the UI is on hold to keep open-core options open. Triggered by a hosted offering decision. |
| Workspace switcher UI for self-hosters | Gated | Same as ***REMOVED***59. |

***REMOVED******REMOVED******REMOVED*** Ecosystem
...
***REMOVED******REMOVED******REMOVED*** Internal cleanup

| Item | Status |
|---|---|
| `Sql` branded-type project-wide adoption | Wanted alongside any refactor touching `qid` / `cq` / `whTable` callsites. |
| [***REMOVED***30 — Parse Google `hd` JWT claim](https://github.com/Fredehagelund92/zugzug/issues/30) | Superseded by generic OIDC support; likely closing. |

---

***REMOVED******REMOVED*** Out of scope (not planned)
...
| [***REMOVED***57 — Branching / "what-if" sandbox](https://github.com/Fredehagelund92/zugzug/issues/57) | Closed pre-v0.1 — UX implications outweighed value for the cases we'd seen. | A steward who needs "preview my remap before committing" with concrete examples. |
| [***REMOVED***56 — History & rollback as a separate epic](https://github.com/Fredehagelund92/zugzug/issues/56) | Folded into ***REMOVED***45. | After ***REMOVED***45 ships, if cross-table time-travel is asked for. |
...
***REMOVED******REMOVED******REMOVED*** When `Now` holds more than one item
