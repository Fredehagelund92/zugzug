...
***REMOVED******REMOVED******REMOVED*** Phase 1 — Extract `WarehouseAdapter` against DuckDB only
...
***REMOVED******REMOVED******REMOVED*** Phase 2 — Implement `SnowflakeAdapter` (gating phase)
...
***REMOVED******REMOVED******REMOVED*** Phase 3 — Canonical-store modes (week 7–8)
...
***REMOVED******REMOVED*** Later — Aug–Sep 2026 (weeks 9–12, due Sep 6)

Planned but not committed. Re-estimate at the mid-cycle review.

***REMOVED******REMOVED******REMOVED*** Phase 4 — Strip BC-isms + MotherDuck-writable (weeks 9–10)
...
- **Children:**
  ...
  - Copy sweep (remove "Zugzug" / BC jargon from UI)
...
***REMOVED******REMOVED******REMOVED*** Phase 6 — Public push + v1.0 tag (week 12)
...
***REMOVED******REMOVED*** Post-v1.0 (v1.1+) — community-PR-welcome bucket
...
***REMOVED******REMOVED*** Parked — BC-internal work (paused 2026-06-08 by OSS pivot)
...
|---|---|---|
| [***REMOVED***59 — Multi-tenant workspaces (phase 1)](https://github.com/Fredehagelund92/zugzug/issues/59) | Schema/middleware work preserved; UI gated behind `ZUGZUG_MULTI_TENANT`. Surfacing for OSS would close the open-core door. | BC asks for multi-tenant UI on their deployment, or cloud product begins. |
| [***REMOVED***45 — Error recovery: canonical_history + per-record revert](https://github.com/Fredehagelund92/zugzug/issues/45) | Not blocking for v1.0; first OSS users won't accumulate enough state for revert to matter on day one. | After v1.0 ships, or first incident where committed mutations need rolling back. |
| [***REMOVED***33 — Bulk operations in Triage + cascade delete](https://github.com/Fredehagelund92/zugzug/issues/33) | UX gap; not adoption-blocking for OSS launch. | After v1.0 ships, or first community feature request. |
| [***REMOVED***54 — E1 Activity & Presence](https://github.com/Fredehagelund92/zugzug/issues/54) | Realtime is a v1.1+ feature; v1.0 ships with current presence. | After v1.0 ships. |
| [***REMOVED***35 — Unified search (Cmd-K)](https://github.com/Fredehagelund92/zugzug/issues/35) | Nice-to-have; doesn't differentiate the OSS pitch. | After v1.0 ships. |
| [***REMOVED***34 — CSV Import/Export](https://github.com/Fredehagelund92/zugzug/issues/34) | The Parquet export endpoint covers the launch-critical "get my data out" path. CSV import is a v1.1 feature. | After v1.0 ships. |
| AI stubs — [***REMOVED***3](https://github.com/Fredehagelund92/zugzug/issues/3), [***REMOVED***4](https://github.com/Fredehagelund92/zugzug/issues/4), [***REMOVED***5](https://github.com/Fredehagelund92/zugzug/issues/5) | Stubs; need brainstorming + scoping. Not adoption-blocking. | After v1.0 ships. |
| [***REMOVED***55 — E2 Concurrent Editing Safety](https://github.com/Fredehagelund92/zugzug/issues/55) | Was already parked behind ***REMOVED***54. | ***REMOVED***54 ships + first last-write-wins incident. |
| [***REMOVED***36 — RBAC phase 2](https://github.com/Fredehagelund92/zugzug/issues/36) | Phase 1 absorbed into ***REMOVED***59. | A tenant asks for non-admin roles. |
| [***REMOVED***30 — Parse Google `hd` JWT claim](https://github.com/Fredehagelund92/zugzug/issues/30) | Google-OAuth-specific; OIDC refactor in Phase 4 supersedes the pattern. | Probably never; superseded. |
| [***REMOVED***15 — Scan scheduler hardening](https://github.com/Fredehagelund92/zugzug/issues/15) | Current scheduler works. | First production scan failure that loses data. |

---

***REMOVED******REMOVED*** Cut / Closed doors (2026-06-08 pivot)
...
| [***REMOVED***57 — E4 Branching / What-if Sandbox](https://github.com/Fredehagelund92/zugzug/issues/57) | Already closed pre-pivot | A steward asks for "preview my remap before committing" |
| [***REMOVED***56 — E3 History & Rollback](https://github.com/Fredehagelund92/zugzug/issues/56) | Folded into ***REMOVED***45 pre-pivot | After ***REMOVED***45 ships, if cross-table time-travel asked for |
...
***REMOVED******REMOVED*** Shipped (OSS pivot cycle)

_Add entries here as phases close. Format: `Phase N — Title — shipped YYYY-MM-DD — note`._

- _(none yet this cycle)_

***REMOVED******REMOVED******REMOVED*** Pre-pivot context (shipped before 2026-06-08 OSS pivot)
