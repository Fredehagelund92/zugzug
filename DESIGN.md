...
***REMOVED******REMOVED******REMOVED*** Theme grounds (light + dark)

Dark is the lead look. Light is a genuine paper theme for stakeholder PDFs and users who prefer it.

| Token | Dark | Light | Use |
|---|---|---|---|
| `--bg` | `***REMOVED***080b14` | `***REMOVED***f4f6fc` | Page background |
| `--surface` | `***REMOVED***0f1526` | `***REMOVED***ffffff` | Cards, panels, the default writable surface |
| `--surface-2` | `***REMOVED***182240` | `***REMOVED***eaeef7` | Nested surface (table rows on hover, secondary panels) |
| `--surface-3` | `***REMOVED***243056` | `***REMOVED***dfe5f2` | Deepest nesting (toolbar wells, code blocks) |
| `--surface-elevated` | `***REMOVED***2b3863` | `***REMOVED***ffffff` | Popovers, dropdowns, modals |
| `--ink` | `***REMOVED***eaeef7` | `***REMOVED***0c1020` | Primary text |
| `--ink-2` | `***REMOVED***9ba7bf` | `***REMOVED***48526a` | Secondary text, labels |
| `--ink-3` | `***REMOVED***5b6884` | `***REMOVED***8893a8` | Tertiary text, placeholders, disabled |
| `--line` | rgba w/.09 | rgba w/.11 | Default borders |
| `--line-2` | rgba w/.17 | rgba w/.20 | Strong borders, scrollbar thumb |

***REMOVED******REMOVED******REMOVED*** Signal colors

| Token | Hex | When to use |
|---|---|---|
| `--accent` | `***REMOVED***d6336c` | The one brand accent. CTAs, focus rings, the live "flow" travelling toward the canonical node, link color. **One accent per view.** |
| `--accent-2` | `***REMOVED***f0a323` | Source-lamp secondary. Source-side decorations, "in-flight" highlights, things being scanned. Never used as a CTA. |
| `--accent-soft`, `--accent-2-soft` | color-mix 18% | Backgrounds, washes, hover halos |

***REMOVED******REMOVED******REMOVED*** Workflow semantics (Zugzug-specific)

Master-data work has two states with no generic analogue. Don't reuse `ok`/`warn` for these.

| Token | Hex | Means |
|---|---|---|
| `--ak-committed` | `***REMOVED***0e9f8a` | Published to the master store. Cooler teal than `ok` green — these are *correct* AND *durable*. |
| `--ak-staged` | `***REMOVED***c47c18` | In-flight draft awaiting commit. Saturated ochre, not the alerting `warn` yellow. |
| `--ak-committed-soft`, `--ak-staged-soft` | color-mix | Row backgrounds, badge fills |

***REMOVED******REMOVED******REMOVED*** Generic status

| Token | Hex | Means |
|---|---|---|
| `--ak-ok` | `***REMOVED***1f9d6b` | Generic success — scan completed, save succeeded |
| `--ak-warn` | `***REMOVED***c7901c` | Attention needed — threshold crossed, source overdue |
| `--ak-danger` | `***REMOVED***d7434b` | Destructive or failure state |
| `--ak-info` | `var(--accent)` | Informational, neutral guidance |

***REMOVED******REMOVED******REMOVED*** Per-table tints
...
***REMOVED******REMOVED******REMOVED*** Brand constants (held across themes)

`--brand-ink ***REMOVED***0c1020 · --brand-paper ***REMOVED***f5f7fc · --brand-graphite ***REMOVED***353d52 · --brand-mist ***REMOVED***c4ccdc`
...
***REMOVED******REMOVED******REMOVED*** Type scale (utility tokens from `app-kit.css`)
...
***REMOVED******REMOVED******REMOVED*** The `[bracket]` cased label
...
***REMOVED******REMOVED******REMOVED*** Layout widths
...
***REMOVED******REMOVED******REMOVED*** Z-index layers
...
***REMOVED******REMOVED******REMOVED*** Tables (the grid)
...
***REMOVED******REMOVED******REMOVED*** Cells (Airtable-style)
...
***REMOVED******REMOVED******REMOVED*** Empty states
...
***REMOVED******REMOVED******REMOVED*** Popovers / dropdowns
...
***REMOVED******REMOVED*** 8. The signature lattice
...
***REMOVED******REMOVED*** 10. How to use this document
