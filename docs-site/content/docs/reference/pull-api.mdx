---
title: Pull API
description: Read published records over HTTP — the recommended way to feed dbt, Fivetran, or any pipeline.
---
...
- **First pull** — call `…/records` with no params, then follow `cursor.next` until it's
  `null`.
